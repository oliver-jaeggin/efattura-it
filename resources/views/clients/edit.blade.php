  ...
  <form id="create-client" name="create-client" action="{{ route('clients.update', $client->id) }}" method="POST">
    ...
    <div class="field-group flex flex--gap-col-s">
      <div class="field-wrapper">
        ...
        <input type="text" name="destination_code" id="destination_code" @error('destination_code') class="is-invalid" @enderror maxlength="7" value="{{ $client->destination_code ?? '' }}" autofocus>
      </div>
      <div class="field-wrapper">
    ...
    <div class="field-group flex flex--gap-col-s">
      <div class="field-wrapper">
        ...
        <input type="text" name="vat_nr" id="vat_nr" @error('vat_nr') class="is-invalid" @enderror value="{{ $client->vat_nr ?? '' }}">
      </div>
